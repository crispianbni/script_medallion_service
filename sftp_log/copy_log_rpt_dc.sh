...
###############################################################################
# Script Name  : copy_log_rpt_dc.sh
# Description  : Script untuk menyalin log medallionPentahoReport_Today.log dari local dan server Repor 2
# Author       : Crispian | 901146
# Division     : IT Application Services
# Last Update  : 23-02-2026
###############################################################################

REMOTE_HOST="192.168.92.108" # Report 2
